    ...
    public class LeaveRequestController : Controller
    {
        ...
        public async Task<ActionResult> ApproveRequest(int id)
        {
            try
            {
                ...
                var allocation =
                    await _leaveAllocationRepository.GetLeaveAllocationByEmloyeeAndTypeAsync(
                        leaveRequest.RequestingEmpoyeeId,
                        leaveRequest.Id
                    );
        ...
        public async Task<ActionResult> Create()
        {
            ...
            var model = new CreateLeaveRequestViewModel { LeaveTypes = leaveTItems };
            return View(model);
        }
        ...
        public async Task<ActionResult> MyLeave()
        {
            ...
            var employeeAllocations =
                await _leaveAllocationRepository.GetLeaveAllocationsByEmloyeeAsync(employeeId);
            var employeeRequests = await _leaveRequestRepository.GetRequestsByEmployeeAsync(
                employeeId
            );
            var employeeAllocationModel = _mapper.Map<List<LeaveAllocationViewModel>>(
                employeeAllocations
            );
